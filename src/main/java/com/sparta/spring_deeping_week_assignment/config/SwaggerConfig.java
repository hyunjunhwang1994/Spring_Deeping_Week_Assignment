...
import static com.sparta.spring_deeping_week_assignment.jwt.JwtUtil.AUTHORIZATION_HEADER;
...
//        Add your custom MappingJackson2HttpMessageConverter
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.sparta.spring_deeping_week_assignment.controller"))
